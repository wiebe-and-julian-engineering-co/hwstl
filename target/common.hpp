...
namespace hwstl {
    static auto cout = hwstl::ostream<hwstl::target::uart_impl<hwstl::target::uart_io::uart>>();
    static auto cin = hwstl::istream<hwstl::target::uart_impl<hwstl::target::uart_io::uart>>();
